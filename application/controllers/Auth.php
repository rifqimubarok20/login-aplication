...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                Your account has been created. Activate your account, please! </div>');
                redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'rfmubarok1118@gmail.com',
            'smtp_pass' => 'dmzwbgbhfupjttjq',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('rfmubarok1118@gmail.com', 'Login App');
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                if (time() - $user_token['date_created'] < (60*60*24)) {
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">'. $email .' has been activated. Login, please!</div>');
                    redirect('auth');
                } else {
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
                Check yout email to reset your password, please! </div>');
